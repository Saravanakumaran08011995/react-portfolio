        ...
        <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
            <ul>
                <li className='w-[160px] h-16px flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600'>
                    <a href="https://www.linkedin.com/in/saravana-kumaran-80b47b259/" className='flex justify-between items-center w-full text-gray-300 py-3' target='_blank'>
                        LinkedIn <FaLinkedin size={30}/>
                    </a>
                </li>
                <li className='w-[160px] h-16px flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]' >
                    <a href="https://github.com/Saravanakumaran08011995" className='flex justify-between items-center w-full text-gray-300 py-3'target='_blank'>
                ...
                <li className='w-[160px] h-16px flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#565f69]'>
                    <a href="https://drive.google.com/file/d/1jq6uki5y5ED9GoPYZIBB7DoOGG9agzuL/view?usp=share_link" className='flex justify-between items-center w-full text-gray-300 py-3'target='_blank'>
